...
python train_gcn_reg.py --save $modelfile --lr 0.01 --nfolds 0 --augmentation no_augmentation --selfloop "none" --reigen 0.01 --nepochs 200 --nlayers 2 --ntrials 1 2>&1 | tee $watchfile
