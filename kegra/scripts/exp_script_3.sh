...
basename=/homes/cx2/gcn/keras-gcn/results/exp_script_3
...
python train_gcn_dg.py --save $modelfile --lr 0.01 --nfolds 10 --augmentation shuffle_mix --alpha 0.001 --nepochs 200 --ntrials 10 2>&1 | tee $watchfile